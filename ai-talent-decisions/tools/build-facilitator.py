...
LEARNER_URL = "https://me5231979.github.io/Course_Library/ai-talent-decisions/"
...
s = s.replace('<title>Talent Calls, Sharper | Vanderbilt</title>',
              '<title>Talent Calls, Sharper, Facilitator Edition | Vanderbilt</title>')
...
# ---- 7. footer marker ----
s = s.replace('Talent Calls, Sharper · A Vanderbilt learning experience',
              'Talent Calls, Sharper · Facilitator Edition · learner link: <a href="' + LEARNER_URL + '" style="color:rgba(255,255,255,.7);text-decoration:underline">me5231979.github.io/Course_Library/ai-talent-decisions</a>')
